...
import '../style.css';
import { getPatientPerscription, getPatientPrescriptionVoice, updatePatientIncentiveGivenStatus, updatePatientPerscriptionStatus } from '../actions/index';
...
class index extends Component {
    constructor(props) {
        ...
        console.log('incentive Given:', props.currentPatient.IncentiveGiven);
        ...
        this.state = {
            ...
            prescriptionVerifiedStatus: [
                { id: 1, text: "Verified" },
                { id: 0, text: "Not Verified" },
            ],

            prescriptionData: {
                IncentiveGiven: props.currentPatient.IncentiveGiven,
    ...
    handleInputChange = event => {
        ...
        if (name === "IncentiveGiven" || name === "IsVerified") {
    ...
    handleSubmit = (event) => {
        ...
        if (common.empty(this.state.prescriptionData.IncentiveGiven))
            return notify("Please select incentive given option first.", 'error', 600);
        
         this.setState({ formDisable: true });

         updatePatientIncentiveGivenStatus(this.state.prescriptionData, (res) => {
            ...
            <Fragment>
                <Popup
                    ...
                    <ScrollView width='100%' height='100%'>
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-sm-4">
                                <RadioGroup
                                        ...
                                        id="IsVerified"
                                        className=""
                                        items={this.state.prescriptionVerifiedStatus}
                                        defaultValue={this.state.prescriptionVerifiedStatus.find(
                        ...
                        <h3>Transfer of incentives</h3>
                        <div className="form-group row">
                            <label htmlFor="staticEmail" className="col-sm-2 col-form-label">Incentive paid against prescriptions</label>
                            <div className="col-sm-3">
                                ...
                                <RadioGroup
                                        ...
                                        defaultValue={this.state.prescriptionStatus.find(
                                            (x) => x.id == this.state.prescriptionData.IncentiveGiven
                                          )}
                                        onValueChanged={(e) => this.handleInputChange(e)}
                                        />
                            </div>
