            ...
            {permission.DASHBOARD_SO &&
                <div className='row '>
                    <div className='col-md-12'>
                        <Chart4 PatientNotif={filterOutcome} Title={'Treatment Outcome'} Lookup={lookupOutcome} />
                    </div>
                </div>
            }
            {permission.DASHBOARD_EA_PHARMACIES &&
                <div className="row ">
                    <div className='col-md-12'>
                        <Chart1 graphPharmacies={graphPharmacies} />
                    </div>
                </div>}
            {permission.DASHBOARD_SO &&
                <div className="row ">
